												...
												<tbody>
													...
													<tr>
														...
														<td>
															...
															<a style="color:red;cursor: pointer;" onclick="setDeleteFunction('<?php echo $row->rid?>')"><i class="zmdi zmdi-delete"></i></a>	
														</td>
														<td><a href="<?php echo base_url('access-authentication/'.$row->role_id)?>"><button style="background-color:#73D3DD;color: #ffff;" class="btn btn-sm ripple ">Access</button></a></td>
													</tr>
													<?php $i++;}}?>
